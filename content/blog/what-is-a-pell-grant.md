...
In order to apply for a Federal Pell Grant, students must file their FAFSA. The FAFSA will evaluate your family's financial need and determine your financial aid package. In addition, it will assess if you are eligible for a grant.
...
- Be enrolled or accepted as a student at a participating degree or certificate program
...
Grants are more or less monies you don't need to pay back. But these additional requirements hold that students:
...
The maximum award amount for the 2025-2026 academic year is $7,395. The actual amount that you may receive will be dependent on your financial need. The minimum amount is 10% of the maximum award.
...
Both scholarships and grants are helpful to paying for college because they are free money. That said, it's important to highlight that grants, like the Federal Pell Grant, are different from scholarships. For starters, scholarships are merit-based, which means they are awarded based on specific achievements, such as academic or athletic accomplishments. Grants are need-based, which means they are evaluated and awarded on demonstrated financial need. While the Pell Grant covers need-based aid, [local scholarships](/local) can supplement your funding regardless of income level.
...
For international students, applying for FAFSA isn't an option. But programs like the Fulbright Scholarship are an option to help with funding. Also, check out other outside scholarships to help fill the gap.

## In Conclusion

Remember that it is always free to file your FAFSA. It is also free to apply for the Pell Grant — this happens automatically through FAFSA. The Pell Grant maximum award is subject to yearly changes. In order to receive the Pell Grant funds again, you must file your FAFSA each year — there are no exceptions. Because a Pell Grant is a grant, you do not need to pay it back.
